...
interface ElasticSupplyPoolInterface extends ethers.utils.Interface {
  functions: {
    ...
    "resyncWeight(address)": FunctionFragment;
...
export class ElasticSupplyPool extends BaseContract {
  ...
  interface: ElasticSupplyPoolInterface;
  ...
  callStatic: {
    ...
    resyncWeight(token: string, overrides?: CallOverrides): Promise<void>;
